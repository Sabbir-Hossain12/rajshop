        ...
        <div class="card">
            <div class="card-body">
                <form action="{{route('settings.update')}}" method="POST" class=row data-parsley-validate=""  enctype="multipart/form-data">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group mb-3">
                            <label for="name" class="form-label">Whats App *</label>
                            <input type="text" class="form-control @error('wp_number') is-invalid @enderror" name="wp_number" value="{{ $edit_data->wp_number}}" id="wp_number" required="">
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="form-group mb-3">
                            <label for="name" class="form-label">Messenger Link *</label>
                            <input type="text" class="form-control @error('messenger') is-invalid @enderror" name="messenger" value="{{ $edit_data->messenger}}" id="messenger" required="">
                        </div>
                    </div>
                    <!-- col-end -->
                    ...
                    <div class="col-sm-6 mb-3">
                        <div class="form-group">
                            ...
                            <textarea name="product_overview" class="form-control @error('product_overview') is-invalid @enderror" id="product_overview" rows="3">{{$edit_data->product_overview}}</textarea>
