                                        ...
                                        <div class="product-cart">
                                            ...
                                            <form action="{{ route('cart.store') }}" method="POST" name="formName">
                                                                    ...
                                                                    @foreach ($productcolors as $key=>$procolor)
                                                                        <div class="selector-item">
                                                                            <input type="radio"
                                                                                ...
                                                                                required />
                                                                            <label for="fc-option{{ $procolor->id }}" onclick="setimg({{$key}})"
                                                                                style="background-image: url(../{{ $procolor->Image }});background-size:cover"
                                                                ...
                                                                @foreach ($productsizes as $prosize)
                                                                    <div class="selector-item">
                                                                        <input type="radio"
                                                                            ...
                                                                            required />
                                                                        <label
                                                                            for="f-option{{ $prosize->id }}" onclick="setprice({{$prosize->RegularPrice}},{{$prosize->SalePrice}})"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="d-block d-lg-none d-flex single_product col-sm-12" style="position: fixed;top: 93.4%;z-index: 9999;left: 0;padding: 0;">
                                                        <input type="submit" class="btn px-4 add_cart_btn" style="border-radius:0px;"
                                                            onclick="return sendSuccess();" name="add_cart"
                                                            value="কার্টে যোগ করুন " />

                                                        <input type="submit"
                                                            class="btn px-4 order_now_btn order_now_btn_m" style="border-radius:0px;margin-left: 0px;"
                                                            onclick="return sendSuccess();" name="order_now"
                                                            value="অর্ডার করুন" />
                                                    </div>
                                                    <div class="d-none d-lg-flex single_product col-sm-12">
    ...
    <div class="container">
        ...
        <div class="row">
                    @foreach ($products as $key => $value)
                        <div class="col-lg-2 col-6 product_item wist_item wow fadeInDown" data-wow-duration="1.5s"
