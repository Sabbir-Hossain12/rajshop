        ...
        <div class="row">
            ...
            <div class="col-sm-3 hidetosm">
                  <div class="rounded-top text-center d-none d-lg-block" style="background-color:#121164;">
                   <h5 class="py-2 text-white bg-danger">CATEGORYS</h5>
                </div>
                            ...
                            @if (!$value->prosizes->isEmpty() || !$value->procolors->isEmpty())
                                <div class="pro_btn">
                                    ...
                                    <div class="cart_btn order_button">
                                        <a href="{{ route('product', $value->slug) }}"
                                            class="addcartbutton btn btn-danger">অর্ডার করুন </a>
                                    </div>
                                </div>
                            @else
                                <div class="pro_btn">
                                    ...
                                    <form action="{{ route('cart.store') }}" method="POST">
                                        ...
                                        <button type="submit" class="bg-danger">অর্ডার করুন</button>
                                    </form>
                                </div>
                            @endif
                        </div>
            ...
            <div class="row">
                <div class="col-sm-12" style="display: flex;justify-content: space-between;">
                    ...
                    <div class="show_more_btn pt-2">
                        <a href="{{ route('category', $homecat->slug) }}" class="view_more_btn bg-danger">View More</a>
                    </div>
                </div>
                <div class="col-sm-12">
